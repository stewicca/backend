...
// get all rooms
router.get('/room', asyncWrapper(async (req: Request, res: Response) => {
...
// create room
router.post('/room', asyncWrapper(async (req: Request, res: Response) => {
...
// update room
router.put('/room/:id', asyncWrapper(async (req: Request, res: Response) => {
  const { number, roomTypeId } = req.body;
...
// delete room
router.delete('/room/:id', asyncWrapper(async (req: Request, res: Response) => {
